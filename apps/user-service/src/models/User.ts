...
const taxInfoSchema = new mongoose.Schema(
  {
    ...
    taxIdType:          { type: String, enum: ['gst', 'vat', 'ein', 'other'], default: null },
...
const verificationDocumentSchema = new mongoose.Schema(
  {
    type: {
      type: String,
      enum: ['government_id', 'business_license', 'tax_certificate', 'address_proof', 'other'],
      required: true,
    },
...
userSchema.index({ 'sellerProfile.storeSettings.storeSlug': 1 }, { unique: true, sparse: true });
